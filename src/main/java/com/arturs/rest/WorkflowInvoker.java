...
public class WorkflowInvoker {
    ...
    private final Logger LOGGER = Logger.getLogger(WorkflowInvoker.class.getName());
    ...
    public String start(@PathVariable String key,
        ...
        try {
            ...
            String businessKey = variables.containsKey("businessKey") ? (String) variables.get("businessKey") : UUID.randomUUID().toString();
